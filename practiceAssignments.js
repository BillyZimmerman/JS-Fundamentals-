...
// const neighborChange = neighbors.pop()
// console.log(neighbors);
...
// neighbors[neighbors.indexOf('Mexico')] = 'South America';
// console.log(neighbors);
// // ======================================================
...
// console.log(`${myCountry.country} has a population of ${myCountry.population} who speak mostly ${myCountry.language}, Fiji has ${myCountry.neighbors} and the capitol is ${myCountry.capital}.`);
...
const myCountry = {
  ...
  describe: function() {
    return(`${this.country} has a population of ${this.population} who speak mostly ${this.language}, Fiji has ${this.neighbors} and the capitol is ${this.capital}, Fiji has ${this.checkIsIsland ? 'no' : ''} neighbors.`);
  }
};
